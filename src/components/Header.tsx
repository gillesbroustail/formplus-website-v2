...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-bg/95 backdrop-blur">
      <div className="container-wide flex items-center gap-6 py-3 md:gap-8">
        <Logo />
        <nav className="hidden flex-1 items-center justify-center gap-7 text-[0.78rem] uppercase tracking-[0.14em] md:flex lg:gap-9">
