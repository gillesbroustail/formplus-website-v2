...
export function MembershipComparison() {
  ...
  return (
    <div>
      ...
      {isStudioZenActive ? (
        <div className="mt-5 rounded-2xl border border-primary bg-surface p-4">
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-xs">
            ...
            <Link href="#studio-zen-pricing" className="text-muted hover:text-text">
              Voir les offres Studio +ZEN
            </Link>
